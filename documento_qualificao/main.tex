...
\pchave{Difusão cultural. Redes neurais em grafos. Grafos temporais heterogêneos. Streaming musical. Vídeo curto.}
\keyword{Cultural diffusion. Graph neural networks. Heterogeneous temporal graphs. Music streaming. Short video.}

% autoria
\author{Cristiano Mendieta}
\advisor{André Luís Vignatti}
...
% Serão redigidos após estabilização dos capítulos centrais.
%\include{0-iniciais/resumo}
%\include{0-iniciais/abstract}

% listas  de figuras, tabelas, abreviações/siglas, símbolos
% Serão habilitadas quando houver conteúdo definitivo.
...
\include{4-metodologia/texto}		% metodologia
\include{5-resultados/texto}		% resultados parciais
\include{6-cronograma/texto}		% cronograma e próximos passos

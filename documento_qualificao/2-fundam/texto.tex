...
Grafos temporais representam relações que mudam ao longo do tempo. Em vez de assumir uma estrutura fixa, o modelo observa eventos, snapshots ou sequências de interações. Essa perspectiva é essencial para difusão musical, pois o momento em que uma música aparece em um chart, passa a compartilhar trajetória com outra música ou se conecta a determinado contexto de gênero altera a interpretação da própria conexão.

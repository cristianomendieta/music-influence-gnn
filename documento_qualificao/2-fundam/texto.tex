...
A literatura costuma distinguir duas formas de modelar grafos temporais \citep{kazemi2020dynamicsurvey}. A primeira discretiza o tempo em snapshots, criando uma sequência de grafos estáticos (grafos dinâmicos em tempo discreto). Essa abordagem é simples e compatível com GNNs tradicionais, sendo particularmente adequada quando os dados são naturalmente agregados por dias ou semanas, como em EvolveGCN e DySAT \citep{pareja2020evolvegcn,sankar2020dysat}. A segunda trata o grafo como uma sequência contínua de eventos temporais (grafos dinâmicos em tempo contínuo), preservando timestamps individuais e permitindo atualizar representações conforme novas interações ocorrem, como em TGAT e TGN \citep{xu2020tgat,rossi2020tgn}.
